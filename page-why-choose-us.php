    ...
    <section class="factor-why-us">
        <div class="container">
            ...
            <div class="factor-why-us__grid">
                ...
                // Fallback defaults if no custom reasons are set
                if ( empty( $reasons ) ) {
                    $reasons = array(
                        array('title' => "When you partner with us, we become 'YOU'", 'copy' => 'Not a tall claim, our clients can vouch for that.'),
                        array('title' => "We start with the 'why' not the 'what'", 'copy' => "Because having clarity on the why's makes it a lot simpler"),
                        array('title' => "We bring simplicity to chaos", 'copy' => 'When companies face growing complexities, they call us.'),
                        array('title' => "We say what we do, and do what we say", 'copy' => 'Complete transparency keeps everything simple for both of us.'),
                        array('title' => "We're not just coders, we're problem solvers", 'copy' => "Being 'solution-oriented' is a mindset we've embraced."),
                        array('title' => "Good engineering with strict quality controls", 'copy' => 'We know you\'re tired of fakes who claim to be what they are not.')
                    );
                }
